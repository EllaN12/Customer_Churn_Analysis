...
# Project root (one level above Phase_4_implementation_and_Monitoring/)
ROOT_DIR = Path(__file__).resolve().parent.parent
DATA_PATH = ROOT_DIR / 'Prediction_Data' / 'recommendation.csv'
RESULTS_PATH = ROOT_DIR / 'venv' / 'Results' / 'visualizations'
...
if __name__ == '__main__':
    ...
    model.plot_results(save_path=str(RESULTS_PATH) + '/')
    ...
    # Save results
    results_csv = ROOT_DIR / 'venv' / 'Results' / 'decision_results.csv'
    decision_results.to_csv(results_csv)
