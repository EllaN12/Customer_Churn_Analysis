...
DATA_PATH = PROJECT_ROOT / 'Results' / 'recommendation.csv'
...
class BayesianChurnModel:
    ...
    def decision_analysis(self, min_effect=0.08, revenue_per_month=78.76):
        """
    ...
    def plot_results(self, save_path='./'):
        ...
        plt.tight_layout()
        plt.savefig(f'{save_path}posterior_treatment_effects.png', dpi=300, bbox_inches='tight')
        print(f"  ✓ Saved: {save_path}posterior_treatment_effects.png")
        plt.close()
        ...
        print(f"  ✓ Saved: {save_path}forest_plot.png")
        plt.close()
        ...
        plt.savefig(f'{save_path}trace_plots.png', dpi=300, bbox_inches='tight')
        print(f"  ✓ Saved: {save_path}trace_plots.png")
        plt.close()
        
        # 4. Pairwise comparison plot
        self._plot_pairwise_comparisons(save_path)
        
        print("✓ All plots generated")
    
    def _plot_pairwise_comparisons(self, save_path):
        ...
        plt.tight_layout()
        plt.savefig(f'{save_path}pairwise_comparisons.png', dpi=300, bbox_inches='tight')
        print(f"  ✓ Saved: {save_path}pairwise_comparisons.png")
        plt.close()
...
if __name__ == '__main__':
    ...
    if not DATA_PATH.exists():
        raise FileNotFoundError(f"Recommendation file not found: {DATA_PATH}")
    ...
    model.plot_results(save_path='/home/claude/')
    ...
    # Save results
    decision_results.to_csv('/home/claude/decision_results.csv')
    print("\n✓ Results saved to decision_results.csv")
