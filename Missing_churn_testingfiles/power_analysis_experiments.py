...
class ExperimentPowerAnalysis:
    ...
    def sample_size_sensitivity(self, experiment='early_tenure'):
        ...
        plt.tight_layout()
        plt.savefig('/mnt/user-data/outputs/sample_size_sensitivity.png', dpi=300, bbox_inches='tight')
        print("\n✓ Saved: sample_size_sensitivity.png")
        plt.close()
    ...
    def _plot_power_comparison(self, df_power, experiment_name):
        ...
        plt.tight_layout()
        plt.savefig('/mnt/user-data/outputs/power_comparison.png', dpi=300, bbox_inches='tight')
